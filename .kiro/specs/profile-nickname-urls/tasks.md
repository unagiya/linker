...
- [ ] 2.2 プロパティ6のプロパティベーステストを実装
  - **プロパティ6: 文字数制限バリデーション**
  - **検証: 要件 2.1**

- [ ]* 2.3 プロパティ7のプロパティベーステストを実装
  - **プロパティ7: 文字種制限バリデーション**
  - **検証: 要件 2.2**

- [ ]* 2.4 プロパティ8のプロパティベーステストを実装
  - **プロパティ8: 記号位置制限バリデーション**
  - **検証: 要件 2.3**

- [ ]* 2.5 プロパティ9のプロパティベーステストを実装
  - **プロパティ9: 連続記号制限バリデーション**
  - **検証: 要件 2.4**

- [ ]* 2.6 プロパティ11のプロパティベーステストを実装
  - **プロパティ11: 予約語制限**
  - **検証: 要件 2.6**
...
- [ ]* 3.1 nicknameServiceのユニットテストを作成
  - 利用可能性チェック関数のテスト
  - プロフィール検索関数のテスト
  - ニックネーム更新関数のテスト
  - 予約語チェック関数のテスト
...
- [ ]* 3.2 プロパティ10のプロパティベーステストを実装
  - **プロパティ10: 大文字小文字無視ユニーク性**
  - **検証: 要件 2.5**

- [ ]* 3.3 プロパティ12のプロパティベーステストを実装
  - **プロパティ12: ニックネームベースURL解決**
  - **検証: 要件 3.1**

- [ ]* 3.4 プロパティ20のプロパティベーステストを実装
